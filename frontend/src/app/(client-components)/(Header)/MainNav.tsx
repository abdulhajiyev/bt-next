    ...
    <div className={`nc-MainNav1 relative z-10 ${className}`}>
      <div className="px-4 lg:container py-4 relative flex justify-between items-center">
        <div className="md:flex justify-start flex-1 space-x-4 sm:space-x-10">
          <Logo className="md:w-24 w-16 self-center" />
          <Navigation />
        </div>
        ...
        <div className="flex md:flex flex-shrink-0 justify-end lg:flex-none text-neutral-700 dark:text-neutral-100 items-center">
          ...
          <div className="flex xl:hidden items-center">
            {/* <SwitchDarkMode className="hidden sm:flex"/> */}
            <div className="px-0.5" />
            <MenuBar className="hakuna"/>
          </div>
        </div>
      </div>
    </div>
