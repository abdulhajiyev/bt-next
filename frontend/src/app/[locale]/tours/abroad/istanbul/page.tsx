    ...
    return (
      <div className="listingSection__wrap">
        ...
        <div className="text-neutral-6000 dark:text-neutral-300">
          <p>
            <b>Day 1: Arrival in Istanbul

            </b>
            <br />
            <br />
            &#9679; Touch down in Istanbul and settle into your hotel.
            <br />
            <br />
            <b>Day 2: Old City Marvels

            </b>
            <br />
            <br />
            &#9679; Explore Hagia Sophia, the Blue Mosque, and the vibrant Grand Bazaar.
            <br />
            <br />
            <b>Day 3: Bosphorus Highlights

            </b>
            <br />
            <br />
            &#9679; Cruise along the Bosphorus and discover the splendors of Topkapi Palace.
            <br />
            <br />
            <b>Day 4: Spice Bazaar & Suleymaniye Mosque

            </b>
            <br />
            <br />
            &#9679; Dive into the Spice Bazaar and visit the exquisite Suleymaniye Mosque.
            <br />
            <br />
            <b>Day 5: Modern Istanbul</b>
            <br />
            <br />
            &#9679; Experience Taksim Square and Istiklal Avenue, soaking in the city's contemporary vibes.
            <br />
            <br />
            Bid farewell to Istanbul, leaving with lasting memories of a city where history and modernity harmonize.
          </p>
        </div>
      </div>
    );
