...
export interface SectionSliderToursProps {
  className?: string;
  itemClassName?: string;
  heading?: string;
  subHeading?: string;
  tours?: TaxonomyType[];
  tourCardType?: "card3" | "card4" | "card5";
  itemPerRow?: 4 | 5;
...
const SectionSliderTours: FC<SectionSliderToursProps> = ({
  ...
  return (
    <div className={`nc-SectionSliderTours ${className}`}>
      ...
      >
        <div className={`relative flow-root`} {...handlers}>
          ...
          {tours.length > currentIndex + numberOfItems ? (
            <NextBtn
              style={{ transform: "translate3d(0, 0, 0)" }}
              onClick={() => changeItemId(currentIndex + 1)}
...
export default SectionSliderTours;
